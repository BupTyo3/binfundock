...
DEFAULT_SECOND_ENTRY_DEVIATION_PERC = '1.5'  # Second EP distance in % from current price
DEFAULT_FIRST_PROFIT_DEVIATION_PERC = '1.5'  # First TP distance in % from current price
DEFAULT_SECOND_PROFIT_DEVIATION_PERC = '2.5'  # Second TP distance in % from entry point price
...
DEFAULT_STOP_LOSS_DEVIATION_PERC = '3.5'  # Stop loss distance in % from current price

DEFAULT_MARKET_SPOT_RAW_URL = 'https://www.binance.com/en/trade/{}'
DEFAULT_MARKET_FUTURES_RAW_URL = 'https://www.binance.com/en/futures/{}'
...
class Config:
    ...
    def __init__(self):
        ...
        self.china_channel = telegram.get('china_channel', None)
        self.china_chat = telegram.get('china_chat', None)
